  ...
  return (
   ...
   <div className='mt-10'>
     <div className='flex justify-between py-8 '>
        ...
        <Link href='/category' className='flex items-center text-[16px] font-medium text-[#16A34A]'>View All Caregories 
     ...
     <div  className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8'>
        {allCategories?.map((category)=><Link href={`/shop/category/${category._id}`} key={category._id} className='bg-white shadow rounded-[8px] p-4 flex flex-col items-center'>
